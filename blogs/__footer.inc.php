...
<footer>
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-6">
            ...
            <div class="col-lg-3  col-md-4 col-sm-4 col-6">
                ...
                <ul>
                    ...
                    <li><a href="../upholstery-cleaning.php">Upholestery Cleaning</a></li>
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <div class="form__wrapp">
                    <div class="input-group">
                        <input type="text" class="form-control" id="newsletterEmail" aria-describedby="news" aria-label="Upload" placeholder="Email address">
                        <button class="btn btn-primary" type="button" id="news" onclick="submitNewsLetterForm()">
                            <img src="../images/svg/send.svg" class="img-fluid" alt="send-svg-icon">
                        </button>
                    </div>
                    <div class="small text-danger email-error" id="newsletterEmail-error"></div>
                </div>
    ...
    <div class="container-fluid copyright mt-5">
        <div class="container d-flex align-items-center justify-content-between py-3"> 
            <div class="fs-6 fw-light">Copyright © <?php echo date('Y');?> ozclean. All rights reserved.</div>
            <!-- <div class="fs-6 fw-light">Website Design & SEO by <a class="link text-dark" href="https://techpullers.com/digital-marketing-company-in-kerala/" target="_blank">Techpullers</a></div> -->
        </div>
    </div>
</footer>
<!-- Footer Wrapper End -->
...
function validateNewsLetterForm() {
    ...
    if(!$("#newsletterEmail").val()) {
        $("#newsletterEmail-error").html("Email is required");
        $("#newsletterEmail").css('border-color','#dc3545');
        valid = false;
    } else if(!$("#newsletterEmail").val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/)) {
        $("#newsletterEmail-error").html("Invalid email");
        $("#newsletterEmail").css('border-color','#dc3545');
        valid = false;
    } else {
        $("#newsletterEmail-error").html("");
        $("#newsletterEmail").css('border-color','#099f1a');
    } 
    return valid;
}
